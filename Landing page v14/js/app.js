...
var html = [
	...
	'<li><button onclick="scrollFunction()"> Home </button> </li>',
	'<li><button onclick="scrollFunction()"> photpgrapher </button>  </li>',
	'<li><button onclick="scrollFunction()"> girl surfing </button></li>',
	'<li><button onclick="scrollFunction()"> Learn to surf </button></li>',
	'</ul>',
...
//para.innerHTML = "<div class='landing__container'><h2>Section 2</h2> </div>";
